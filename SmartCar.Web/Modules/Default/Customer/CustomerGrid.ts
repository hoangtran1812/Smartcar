...
namespace SmartCar.Default {
    ...
    import ctmfld = CustomerRow.Fields;
    ...
    export class CustomerGrid extends Serenity.EntityGrid<CustomerRow, any> {
        ...
        private numericInputFormatter(ctx) {
            ...
            var item = ctx.item as CustomerRow;
        ...
        protected getQuickFilters() {
            ...
            let wkkDate: Date = this.addDays(new Date(), 14);
            let mthDate: Date = this.addDays(new Date(), 30);
            let filter = Q.first(flt, x => x.field == fld.StatusId);
            ...
            filter.handler = h => {
                ...
                if (h.active) {
                    if (currDate.getMonth() == wkkDate.getMonth()) {
                        ...
                        h.request.Criteria = Serenity.Criteria.and(h.request.Criteria,
                            [[ctmfld.DateOfRegistry], '<=', wkkDate.getDate()]);
                        h.request.Criteria = Serenity.Criteria.and(h.request.Criteria,
                        ...
                        h.request.Criteria = Serenity.Criteria.or(
                            ...
                            Serenity.Criteria.and(h.request.Criteria,
                                [[ctmfld.DateOfRegistry], '<=', wkkDate.getDate()],
                                [[ctmfld.MonthOfRegistry], '=', wkkDate.getMonth()+1]));
                    }
                }
            };
