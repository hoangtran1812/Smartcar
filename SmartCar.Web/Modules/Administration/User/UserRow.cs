...
namespace SmartCar.Administration.Entities
{
    ...
    public sealed class UserRow : LoggingRow, IIdRow, INameRow, IIsActiveRow
    {
        ...
        [DisplayName("Group"), NotNull, ForeignKey(typeof(Default.Entities.GroupsRow)), LeftJoin("jRegion")]
        ...
        [Origin("jRegion"), DisplayName("Nhóm"), QuickSearch, LookupInclude]
